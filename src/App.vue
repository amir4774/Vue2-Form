...
import ContextMenuProvider from "./components/containers/ContextMenuProvider.vue";
...
<template>
  <ContextMenuProvider whichMenu="root" v-slot="{ setCoordinate, hideMenu }">
    <AppAside :setCoordinate="setCoordinate" :hideMenu="hideMenu" />
  </ContextMenuProvider>
</template>
